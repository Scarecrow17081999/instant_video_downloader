...
export default function SelectLanguage() {
  ...
  return (
    <div className="selectLanguageMainContainer">
      <h1 className="f3 m-4">Select Language</h1>

      <div className="selectLanguageContainer">
        <Select
          onChange={(event, newValue) => handleLanguageChange(newValue)}
          style={{ width: "100%", padding: "0.9rem", borderRadius: "15px" }}
          ...
          defaultValue={10}
        >
          <Option className="CustomSelect-option" value={"en"}>
            English
          </Option>
          <Option className="CustomSelect-option" value={"ko"}>
            Korean
          </Option>
          <Option className="CustomSelect-option" value={"chi"}>
            Chinese
          </Option>
        </Select>
        <Styles />
